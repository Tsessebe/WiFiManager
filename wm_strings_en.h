...
const char HTTP_INFO_uptime_H[]   PROGMEM = "<dt>Uptime</dt><dd>{1} hrs {2} mins {3} secs</dd>";
const char HTTP_INFO_uptime_D[]   PROGMEM = "<dt>Uptime</dt><dd>{1} days {2} hrs {3} mins {4} secs</dd>";
